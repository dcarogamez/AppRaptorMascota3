...
import {Proveedor, ProveedorRelations, Registro, ConsultaServ, ProductoServicio, DetallePedido} from '../models';
...
> {
  ...
  public readonly registro: HasOneRepositoryFactory<Registro, typeof Proveedor.prototype.id>;
